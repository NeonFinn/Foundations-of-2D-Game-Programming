...
window.onfocus = function (e) {  // unpause if paused
   ...
   if (snailBait.paused) {
      ...
      if (snailBait.windowHasFocus && snailBait.countdownInProgress)
         snailBait.revealToast('5', 500); // Display 5

      setTimeout(function (e) {
         if (snailBait.windowHasFocus && snailBait.countdownInProgress)
            snailBait.revealToast('4', 500); // Display 4

         setTimeout(function (e) {
            if (snailBait.windowHasFocus && snailBait.countdownInProgress)
               snailBait.revealToast('3', 500); // Display 3

            setTimeout(function (e) {
               if (snailBait.windowHasFocus && snailBait.countdownInProgress)
                  snailBait.revealToast('2', 500); // Display 2

               setTimeout(function (e) {
                  if (snailBait.windowHasFocus && snailBait.countdownInProgress)
                     snailBait.revealToast('1', 500); // Display 1
