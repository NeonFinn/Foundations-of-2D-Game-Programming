var SnailBait = function () {
   ...
   this.batData = [
      { left: 164,
         top: this.TRACK_2_BASELINE - 1 *this.BAT_CELLS_HEIGHT },
   ...
   this.beeData = [
      { left: 100,
         top: this.TRACK_1_BASELINE - 3*  this.BEE_CELLS_HEIGHT*1.5 },
      { left: 255,
         top: this.TRACK_2_BASELINE - 2 *this.BEE_CELLS_HEIGHT*1.5 },
      { left: 576,
